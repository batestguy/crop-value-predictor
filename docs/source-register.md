...
|---|---|---|---|---|
| [World Bank RTFP](https://microdata.worldbank.org/catalog/4503) | Primary monthly market-price continuity | Nigeria catalog reports 73 markets, 2007 onward, open-data publication, and explicitly distinguishes direct and ML-estimated values | Public catalog/download; no browser dependency | Confirm downloadable file URL, product/form mapping, unit conversions, observed vs imputed flags, and redistribution attribution |
